...
$requiredSourceEntries = @(
    ...
    'DVSeasons/Source/DVSeasons.Common/AutumnEffectsProfile.cs',
    'DVSeasons/Source/DVSeasons.Common/SeasonalThermalProfile.cs',
    'DVSeasons/Source/DVSeasons.Game/SeasonalTextureController.cs',
    'DVSeasons/Source/DVSeasons.Game/AutumnLeafParticleTexture.cs',
    'DVSeasons/Source/DVSeasons.Game/AutumnLeafGroundController.cs',
    'DVSeasons/Source/DVSeasons.Game/AutumnTreeSourceProvider.cs',
    'DVSeasons/Source/DVSeasons.Game/SeasonalThermalController.cs',
    'DVSeasons/Source/DVSeasons.Game/SnowFootstepAudioController.cs',
    'DVSeasons/Source/DVSeasons.Game/StreamingTextureReadiness.cs',
    ...
    'DVSeasons/Source/DVSeasons.Tests/SeasonalThermalProfileTests.cs',
    'DVSeasons/Source/Docs/SEASONAL_THERMAL_PHYSICS.md',
    ...
    'DVSeasons/Source/DVSeasons.Unity/Assets/Editor/StreamingTextureReadinessVerification.cs',
