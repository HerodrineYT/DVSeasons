Shader "Hidden/DVSeasons/SnowAccumulationReference20260919"
{
    Properties
    {
        ...
        Pass
        {
            ...
            float4 accumulationFragment(accumulationOutput i):SV_Target
            {
                ...
                float open=d<_DVPSNearArea.z*0.85 ? sky(_DVPSNearHeight,_DVPSNearArea,_DVPSAccumulation.z,world)
                    : farDistance<_DVPSFarArea.z*.95 ? sky(_DVPSFarHeight,_DVPSFarArea,_DVPSAccumulation.w,world)
                    : sky(_DVPSDistantHeight,_DVPSDistantArea,_DVPSDistantOffset,world);
