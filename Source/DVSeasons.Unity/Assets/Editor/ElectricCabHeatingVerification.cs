...
{
    public static class ElectricCabHeatingVerification
    {
        public static void Run()
        {
            ...
            try
            {
                Assembly.LoadFrom(Path.Combine(root, "artifacts/verification/VerifyElectricCabHeating.dll"))
                    .GetType("VerifyElectricCabHeating").GetMethod("Run").Invoke(null, new object[] { mod });
            }
